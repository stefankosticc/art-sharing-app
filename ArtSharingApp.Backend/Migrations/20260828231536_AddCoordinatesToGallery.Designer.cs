...
namespace ArtSharingApp.Backend.Migrations
{
    ...
    [Migration("20260828231536_AddCoordinatesToGallery")]
    partial class AddCoordinatesToGallery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtSharingApp.Backend.Models.Artwork", b =>
                {
                    ...
                    b.HasIndex("IsPrivate", "Date", "CreatedByArtistId")
                        .HasDatabaseName("IX_Artwork_IsPrivate_Date_CreatedByArtistId");

                    b.ToTable("Artworks");
                });

            modelBuilder.Entity("ArtSharingApp.Backend.Models.Auction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ArtSharingApp.Backend.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ArtSharingApp.Backend.Models.Followers", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ArtSharingApp.Backend.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ArtSharingApp.Backend.Models.Offer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ArtSharingApp.Backend.Models.ChatMessage", b =>
                {
                    b.HasOne("ArtSharingApp.Backend.Models.User", "Receiver")
                        .WithMany("ReceivedMessages")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ArtSharingApp.Backend.Models.User", "Sender")
            ...
            modelBuilder.Entity("ArtSharingApp.Backend.Models.Followers", b =>
                {
                    b.HasOne("ArtSharingApp.Backend.Models.User", "Follower")
                        .WithMany("Following")
            ...
            modelBuilder.Entity("ArtSharingApp.Backend.Models.Notification", b =>
                {
                    b.HasOne("ArtSharingApp.Backend.Models.User", "Recipient")
            ...
            modelBuilder.Entity("ArtSharingApp.Backend.Models.Offer", b =>
                {
                    b.HasOne("ArtSharingApp.Backend.Models.Auction", "Auction")
                        .WithMany("Offers")
